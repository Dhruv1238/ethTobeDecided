  ...
  return (
    <>
      ...
      <motion.div
        ...
        style={{ y }}
        className="flex items-center flex-col flex-grow pt-2"
      >
        {/* Swipe Indicator */}
        <div className="mb-6 flex flex-col items-center">
          ...
          <span className="text-sm text-gray-400 mt-2">Swipe down for leaderboard</span>
        </div>
        ...
        <div className="px-5 max-w-4xl w-full">
          <h1 className="text-center mb-8">
            ...
            <span className="text-xl text-[#a3a2a7]">Stake your steps, earn rewards</span>
          </h1>
